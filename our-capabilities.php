...
<head>
    ...
    <meta name="keywords"
        content="packaging capabilities, sustainable packaging solutions, packaging simulation,  end-to-end packaging, packaging optimization, supply chain packaging, eco-friendly packaging solutions">
    <meta name="description"
        content="Discover Packfora's packaging capabilities—driven by simulation, sustainability, and value chain insights to impact People, Planet, and Profit.">
    <meta name="author" content="Packfora">
    <link rel="canonical" href="https://packfora.com/our-capabilities.php">

    <!-- Title  -->
    <title>Packaging Capabilities | Sustainable, Profitable Solutions</title>
...
<body>
    ...
    <main>
        <!-- ==== Start Home Banner ==== -->
        <section class="capabilities-title-banner"
            style="background-image: url(assets/img/capabilities/our-capabilities-banner.webp); background-size: cover; background-position: top center; background-repeat: no-repeat, no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="page-title-bar text-center wow fadeInUp" data-wow-delay="0.4s">
                        <h2>We Believe in the Impact We Create</h2>
                        <h3>At Packfora, we don't just optimise packaging.<br>We engineer impact — <span>People, Planet,
                                & Profit.</span></h3>
                        <div class="capabilities-banner-btn mt-50">
        ...
        <!-- ==== Start People, Planet, and Profit ==== -->
        <section class="deliver-measurable-results my-5">
            <div class="container">
                <div class="row">
                    <p class="mb-4 wow fadeInUp" data-wow-delay="0.2s">It's why global brands trust us to drive
                        packaging decisions that deliver measurable results</p>
                </div>
                <?php 
                    $impactData = [];
                ...
                <div class="row">
                    ...
                    foreach ($impactData as $impact):
                        // Create dynamic class like measurable-results-01, 02, 03
                        $sectionClass = sprintf("measurable-results-%02d", $i);
                    ?>
                        <div class="col-md-4 measurable-results <?= $sectionClass ?> wow fadeInUp" data-wow-delay="0.2s">
                            <div class="measurable-result">
                                <h2 class="heading"><?= htmlspecialchars($impact['heading']) ?></h2>
                                <div class="overlay">
                                    <div class="text">
                                        <h3 class="values"><?= htmlspecialchars($impact['value1_title']) ?></h3>
                                        <p class="values-content"><?= htmlspecialchars($impact['value1_description']) ?></p>
                                    </div>
                                    <div class="text">
                                        <h3 class="values"><?= htmlspecialchars($impact['value2_title']) ?></h3>
                                        <p class="values-content"><?= htmlspecialchars($impact['value2_description']) ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- ==== End People, Planet, and Profit ==== -->

        <!-- ==== Start Impact Enabled ==== -->
        <?php // Fetch data
            $data = [];
            $sql = "SELECT * FROM tbl_impact_enabled WHERE is_delete = 1 ORDER BY id ASC";
            $result = $conn->query($sql);
            ...
            ?>
        <section class="impact-enabled py-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="sec-title wow fadeIn">How Is This Impact Enabled?</h2>
                        <p class="wow fadeIn" data-wow-delay="0.2s">These outcomes aren't accidental. They are the
                            result of an intentional way of working</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <?php foreach ($data as $item): ?>
                        <div class="col-md-4 py-4">
                            <div class="intentional-way text-center wow zoomIn" data-wow-delay="0.4s">
                                <div class="icon">
                                    <img src="<?= BASE_URL. htmlspecialchars($item['image']) ?>" alt="Impact Icon" class="img-fluid">
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="sp-info text-center">
                            <h6 class="wow fadeInUp" data-wow-delay="0.2s">The Mission?</h6>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">Unlock Unimaginable Business Impact using
                                Packaging as a Strategic Business Weapon.</p>
                        </div>
                        <div class="our-team-banner-btn text-center mt-40 wow fadeInUp" data-wow-delay="0.6s">
                            <a href="case-studies.php" class="read_more mb-4 mb-md-0">Case Study</a>
                            <a href="knowledge-centre.php" class="read_more">Knowledge Centre</a>
                        </div>
                    </div>
                </div>
            </div>
