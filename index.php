        ...
        <section class="home-slider">
            <div class="owl-carousel owl-theme hero-slider">
                <div class="item slide1">
                    <div class="container">
                        <div class="content">
                            <h2 class="wow fadeInUp" data-wow-delay="0.2s">Unlock Unimaginable Business Impact Using
                                Packaging as a Business Weapon</h2>
                            <a href="about-us.php" class="read_more wow fadeInUp" data-wow-delay="0.4s">Learn more about
                                us</a>
                        </div>
                    </div>
                </div>
                <div class="item slide5">
                    <div class="container">
                        <div class="content">
                            ...
                            <p>Digitalise your Mold Management</p>
                            ...
                            <div class="box wow fadeInUp" data-wow-delay="0.2s">
                                <div class="box-inner box-inner1">
                                    <div class="box-front">
                                        ...
                                        <p class="title-font">1000+ <br>Years</p>
                                    </div>
                                    <div class="box-back">
                                        <p class="title-font">Delivering industry expertise and strategic
                                            innovation to
                                            solve every packaging challenge.</p>
                                        <a href="about-us.php">
                                            <h3>Learn More</h3>
                                        </a>
                                    </div>
                            ...
                            <div class="box wow fadeInUp" data-wow-delay="0.4s">
                                <div class="box-inner box-inner2">
                                    <div class="box-front">
                                        ...
                                        <p class="title-font">140+ <br>Experts</p>
                                    </div>
                                    <div class="box-back">
                                        <p class="title-font">Innovating packaging solutions that drive
                                            efficiency,
                                            sustainability, and market leadership.</p>
                                        <a href="about-us.php">
                                            <h3>Learn More</h3>
                                        </a>
                                    </div>
                            ...
                            <div class="box wow fadeInUp" data-wow-delay="0.6s">
                                <div class="box-inner box-inner1">
                                    <div class="box-front">
                                        ...
                                        <p class="title-font">21+ <br>Countries</p>
                                    </div>
                                    <div class="box-back">
                                        <p class="title-font">Empowering global brands to achieve scalable,
                                            future-proof
                                            packaging success.</p>
                                        <a href="about-us.php">
                                            <h3>Learn More</h3>
                            ...
                            <div class="box wow fadeInUp" data-wow-delay="0.8s">
                                <div class="box-inner">
                                    <div class="box-front">
                                        ...
                                        <p class="title-font">70+ <br>Clients</p>
                                    </div>
                                    <div class="box-back">
                                        <p class="title-font">Committed to a customer-first approach, delivering
                                            trust,
                                            innovation, and brand excellence.</p>
                                        <a href="about-us.php">
                                            <h3>Learn More</h3>
                                        </a>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <p class="service-info mb-4 wow fadeInUp" data-wow-delay="0.2s">Our company unites
                            ...
                            sustainable, and tailored to our clients' needs.</p>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="services-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.4s">
                                <div>
                                    <a href="packaging-innovation-and-engineering.php">
                                        <div class="service-img">
                                            <img src="assets/img/services/packaging-innovation-engineering.webp"
                                                class="w-100">
                                        </div>
                                        <div class="service-content">
                        ...
                        <div class="col-lg-4">
                            <div class="services-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.6s">
                                <div>
                                    <a href="sustainability.php">
                                        <div class="service-img">
                                            <img src="assets/img/services/sustainability.webp" class="w-100">
                                        </div>
                                        <div class="service-content">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="services-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.2s">
                                <div>
                                    <a href="supply-chain-automation.php">
                                        <div class="service-img">
                                            <img src="assets/img/services/supply-chain-automation.webp" class="w-100">
                                        </div>
                                        <div class="service-content">
                        ...
                        <div class="col-lg-4">
                            <div class="services-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.4s">
                                <div>
                                    <a href="maxmold.php" target="_blank">
                                        <div class="service-img">
                    ...
                    <div class="image-container">
                        ...
                        <div class="image-column">
                            <div class="image-wrapper">
                                <img src="assets/img/home/impact/people.webp" alt="People">
                                <h2 class="heading">People</h2>
                                <p class="sub-text">Powering Brands, Driving Innovation</p>
                                <div class="overlay">
                                    <div class="text">
                                        <h3 class="values">5Bn.US$</h3>
                                        <p class="values-content">Brand Value Covered</p>
                                    </div>
                                    <div class="text">
                                        <h3 class="values">12</h3>
                                        <p class="values-content">Innovations Delivered</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="image-column">
                            <div class="image-wrapper">
                                <img src="assets/img/home/impact/planet.webp" alt="Planet">
                                <h2 class="heading">Planet</h2>
                                <p class="sub-text">Built for Sustainability, Engineered for Impact</p>
                                <div class="overlay">
                                    <div class="text">
                                        <h3 class="values">100KT.</h3>
                                        <p class="values-content">Carbon Reduction</p>
                                    </div>
                                    <div class="text">
                                        <h3 class="values">52KT.</h3>
                                        <p class="values-content">Material Reduction</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="image-column">
                            <div class="image-wrapper">
                                <img src="assets/img/home/impact/profits.webp" alt="Profit">
                                <h2 class="heading">Profit</h2>
                                <p class="sub-text">Smarter Spend, Bigger Gains</p>
                                <div class="overlay">
                                    <div class="text">
                                        <h3 class="values">2.5Bn.US$</h3>
                                        <p class="values-content">Spend Covered</p>
                                    </div>
                                    <div class="text">
                                        <h3 class="values">500-1000BPS</h3>
                                        <p class="values-content">Savings Delivered</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item" style="background-image: url('assets/img/case-study/case-study-01.webp');">
                            <div class="slide-content">
                                <div class="content-box">
                                    <div>
                                        <h2>Packfora enabled a leading FMCG brand to cut costs by 30% while
                                            enhancing recyclability and sustainability.</h2>
                                    </div>
