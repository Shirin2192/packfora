...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-title-bar text-center">
                        ...
                        <h1 class="wow fadeInUp" data-wow-delay="0.2s">Make Your Packaging Shine</h1>
                        <p class="wow fadeInUp" data-wow-delay="0.4s">Thank you for your interest in Packfora. Whether
                            you're exploring new possibilities, looking
                            for the right talent, or just curious about how we work—we're truly glad you're here.</p>
                        <div class="about-banner-btn mt-40 wow fadeInUp" data-wow-delay="0.2s">
                            <a href="#get-in-touch" class="read_more">Send us a message!</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="get-in-touch">
            <div class="container">
                <div class="get-in-touch py-5  wow zoomIn" data-wow-delay="0.2s">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-11">
                            <div class="contact-us-form">
                                <form id="contact-us-form" method="post" action="contact-save.php" novalidate="true">
                                    <div class="messages"></div>
                                    <div class="controls">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="dropdown-wrapper mb-4" id="inquiryDropdown">
                                                    <div class="dropdown-header" id="selectedText">Inquiry Type
                                                    </div>
                                                    <div class="dropdown-options">
                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Talent Flex">Talent Flex</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Sustainability">Sustainability</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Supply Chain Automation">Supply Chain
                                                            Automation</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Product Innovation">Product Innovation</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Design to Value">Design to Value</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Mold Management">Mold Management</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Packaging Innovation & Engineering">Packaging
                                                            Innovation & Engineering</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Packaging Procurement">Packaging
                                                            Procurement</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Specification Management">Specification
                                                            Management</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="MaxMold Inquiry">MaxMold Inquiry</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Packforum">Packforum</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Partnership Opportunity">Partnership
                                                            Opportunity</label>

                                                        <label><input type="radio" name="inquiry_type"
                                                                value="Career Opportunity">Career Opportunity</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="form_hear_about_us">How did you get to know about us?
                                                        <span class="star">*</span></label>

                                                    <select id="form_hear_about_us" name="hear_about_us" required>
                                                        <option value="" disabled selected>Select an option</option>
                                                        <option value="LinkedIn">LinkedIn</option>
                                                        <option value="Referral from a Packforian">Referral from a
                                                            Packforian</option>
                                                        <option value="Online Job Portal">Online Job Portal</option>
                                                        <option value="Campus/Placement Cell">Campus/Placement Cell
                                                        </option>
                                                        <option value="Industry Event or Conference">Industry Event or
                                                            Conference</option>
                                                        <option value="Search Engine">Search Engine</option>
                                                        <option value="Through a Client or Partner">Through a Client or
                                                            Partner</option>
                                                        <option value="Social Media">Social Media (Instagram, Twitter,
                                                            etc.)</option>
                                                        <option value="Other">Other (please specify)</option>
                                                    </select>

                                                    <!-- Hidden Textbox for "Other" -->
                                                    <input type="text" id="other_hear_about_us"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="Full_Name">Full Name<span class="star">*</span></label>
                                                    <input id="Full_Name" type="text" name="FullName"
                                                        placeholder="Your full name" oninput="validateInput(this)">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input id="Company_Name" type="text" name="CompanyName"
                                                        placeholder="Your company name" oninput="validateInput(this)">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                ...
                                                <!-- <div class="form-group mt-2 mb-4">
                                                    <label for="Phone_Number">Country Code + Phone Number<span
                                                            class="star">*</span></label>
                                                    <input id="Phone_Number" class="NumberOnly" type="text" name="PhoneNumber"
                                                        placeholder="Your phone number" maxlength="14" minlength="14">
                                                </div> -->
                                                <div class="col-lg-6">
                                                    <div class="form-group mt-2 mb-4">
                                                        ...
                                                        <div style="display: flex; gap: 8px;">
                                                            ...
                                                            <select name="country_code" id="country_code" required
                                                                ...
                                                                <option value="+387">+387 (Bosnia & Herzegovina)
                                                                </option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <textarea id="Message" name="Message"
                                                        placeholder="Write your message here..." class="pb-0"
                                                        rows="5"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="validation mb-4">
                                                    ...
                                                    <div class="g-recaptcha"
                                                        data-sitekey="6LeNthorAAAAAO64T9sPBeHZz_11yzHGDOeJRDQ7"
                                                        data-secretkey="6LeNthorAAAAAOczGdQhUkF0laY7_1_hXiehlVUU"></div>
                                                </div>
                                                <div class="personal-info mb-4">
                                                    <p style="color: #373737;">Packfora is committed to safeguarding
                                                        your personal information.</p>
                                                    <p>Your data will be processed in accordance with applicable data
                                                        protection laws, our internal governance standards, and our
                                                        privacy policy. As a global company, Packfora and its affiliates
                                                        may store and process your information in jurisdictions outside
                                                        your country of residence. Regardless of location, we ensure
                                                        your information is treated with the highest standards of
