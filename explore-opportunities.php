...
<body>
    ...
    <main>
        ...
        <section class="our-team-page-title-banner"
            style="background-image: url(assets/img/our-team/our-team-banner.webp); background-size: cover; background-position: top center; background-repeat: no-repeat, no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="page-title-bar text-center">
                        <h1 class="wow fadeInUp" data-wow-delay="0.2s">Join Our Team</h1>
                        <h2 class="wow fadeInUp" data-wow-delay="0.4s">I Shine. We Shine. Client Shine.</h2>
                        <div class="our-team-banner-btn mt-40">
                            <a href="#current-openings" class="read_more mb-4 mb-md-0 wow fadeInUp" data-wow-delay="0.4s">Current Openings</a>
                            <a href="why-packfora.php" class="read_more wow fadeInUp" data-wow-delay="0.4s">Why Join Packfora?</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shine-us py-5">
            <div class="container">
                <div class="row">
                    <h2 class="shine-us-title mb-50 wow fadeIn">Shine With Us</h2>
                </div>
                <div class="row shine-us-wrapper">
                    <div class="col-md-12">
                        <div class="shine-us-card shine-us-cards mb-4">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="card-img">
                                        <img src="assets/img/our-team/diversity-equity-inclusion.webp" alt="Jameson">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="card-content card-content-right">
                                        ...
                                        <p>We're creating a workplace where different perspectives are not just
                                            welcomed but celebrated. Because we believe diversity sparks innovation,
                                            equity builds trust, and inclusion creates space for everyone to thrive.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row flex-column-reverse flex-md-row">
                                <div class="col-md-7">
                                    <div class="card-content card-content-left">
                                        ...
                                        <p>We invest in our employees' professional growth through structured learning,
                                            leadership development, and hands-on exposure to the packaging value chain.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="card-img">
                                        <img src="assets/img/our-team/learning-development.webp" alt="Jameson">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="shine-us-card shine-us-cards mb-4">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="card-img">
                                        <img src="assets/img/our-team/employee-well-being.webp" alt="Jameson">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="card-content card-content-right">
                                        ...
                                        <p>We prioritize the well-being of our employees and their families by creating
                                            a healthy work environment and offering meaningful support programs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="shine-us-card shine-us-cards">
                            <div class="row flex-column-reverse flex-md-row">
                                <div class="col-md-7">
                                    <div class="card-content card-content-left">
                                        <div class="d-flex">
                                        ...
                                        <p>Our employees gain exposure to global projects and leadership development
                                            initiatives, opening doors to new career opportunities and professional
                                            advancement.</p>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="card-img">
                                        <img src="assets/img/our-team/global-exposure.webp" alt="Jameson">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="current-openings" id="current-openings">
            <div class="container">
                <div class="shine-us py-5">
                    <div class="row">
                        <h2 class="shine-us-title wow fadeInUp" data-wow-delay="0.2s">Current Openings</h2>
                        <p class="mb-30 wow fadeInUp" data-wow-delay="0.4s">Find your place at Packfora</p>
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="shine-us-card mb-4 wow zoomIn" data-wow-delay="0.2s">
                                <div class="card-content card-content-left">
                                    <div class="d-flex">
                                        <h3 class="mb-1">Packaging Consultant</h3>
                                        <img src="assets/img/home/intro/Vector.png" alt="Jameson">
                                    </div>
                                    <h4 class="mb-1">Location: Remote | Full-Time</h4>
                                    <p>Lead Clients projects to deisgn suatainable packaging solutions.</p>
                                    <button type="button" class="read-more border-0" data-bs-toggle="modal"
                                        data-bs-target="#PackagingConsultant">
                                        Apply Now
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="shine-us-card wow zoomIn" data-wow-delay="0.2s">
                                <div class="card-content card-content-left">
                                    <div class="d-flex">
                                        <h3 class="mb-1">Sustainable Specialist</h3>
                                        <img src="assets/img/home/intro/Vector.png" alt="Jameson">
                                    </div>
                                    <h4 class="mb-1">Location: New York, NY | Full-Time</h4>
                                    <p>Advise clients on eco-friendly materials and circular economy strategies.</p>
                                    <button type="button" class="read-more border-0" data-bs-toggle="modal"
                                        data-bs-target="#PackagingConsultant">
                                        Apply Now
                                    </button>
        ...
        <section class="next-opportunity"
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="sp-info">
                            <h6 class="wow fadeInUp" data-wow-delay="0.2s">Your next opportunity could be just ahead</h6>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="sp-info float-end wow fadeInUp" data-wow-delay="0.2s">
                            <a href="contact-us.php" class="read_more">Get Job Alerts</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="PackagingConsultant" tabindex="-1" aria-labelledby="PackagingConsultantLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="PackagingConsultantLabel">Apply Now</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body contact-sa pt-2">
                    <div class="contact-form">
                        <form id="career-apply-form" method="post" action="javascript:void(0)" novalidate="true">
                            ...
                            <div class="controls row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_name" type="text" name="name" placeholder="Your full name"
                                            required="required" oninput="validateInput(this)">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <!-- <div class="form-group">
                                        <label for="form_phone">Phone Number<span class="star">*</span></label>
                                        <input id="form_phone" type="text" class="NumberOnly" name="phone" placeholder="Your phone number"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="form_position">Position Applying For<span
                                                class="star">*</span></label>
                                        <select id="form_position" name="position" required>
                                            <option value="" disabled selected>Select a position</option>
                                            <option value="Packaging Consultant">Packaging Consultant</option>
                                            <option value="Sustainable Specialist">Sustainable Specialist</option>
                                        </select>
                                        <span class="error-text text-danger"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="form_resume">Upload Resume<span class="star">*</span></label>
                                        <div class="custom-file-upload">
                                            <input type="file" id="form_resume" name="resume" accept=".pdf,.doc,.docx"
                                                required>
                                            <label for="form_resume" class="upload-label">Choose File</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        <label for="form_message">Why are you a good fit for this role?</label>
    ...
    <script src="assets/view_js/carrer.js"></script>
    ...
    $(function() {
        ...
        if (width > 991) {
            ...
            const cards = gsap.utils.toArray(".shine-us-cards");
