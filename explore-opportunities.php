         ...
         <div class="shine-us py-5">
            <div class="container">
               ...
               <div class="row shine-us-wrapper">
                  <?php
                     $query = "SELECT * FROM tbl_shine_with_us WHERE is_delete = '1' ORDER BY id ASC";
                     ...
                     if ($result->num_rows > 0):
                         ...
                         while ($row = $result->fetch_assoc()):
                             ...
                             // Alternate layout every row
                             $isReversed = $count % 2 !== 0;
                     ?>
                  <div class="col-md-12">
                     <div class="shine-us-card shine-us-cards mb-4">
                        <div class="row <?= $isReversed ? 'flex-column-reverse flex-md-row' : '' ?>">
                           <?php if ($isReversed): ?>
                           <div class="col-md-7">
                              <div class="card-content card-content-left">
                                 <div class="d-flex">
                                    <h3><?= $title ?></h3>
                                    <img src="assets/img/shape/vector.png" alt="Vector">
                                 </div>
                                 <p><?= $description ?></p>
                              </div>
                           </div>
        ...
        <section class="current-openings" id="current-openings">
            <div class="container">
                <div class="shine-us py-5">
                    ...
                    <div class="row">
                        <?php
                        $query = "SELECT * FROM current_opening WHERE is_delete = 1 ORDER BY id ASC";
                        $result = $conn->query($query);
                            ...
                            <div class="shine-us-card mb-4 wow zoomIn" data-wow-delay="0.2s">
                                <div class="card-content card-content-left">
                                    <div class="d-flex">
                                        ...
                                        <img src="assets/img/home/intro/Vector.png" alt="Vector">
                                    </div>
                        ...
                        <?php
                            ...
                            echo '<div class="col-md-12 text-center"><p>No openings available at this time.</p></div>';
                        endif;
                        ?>
                    </div>
                </div>
