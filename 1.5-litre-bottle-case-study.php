...
<body>
    ...
    <main>
        ...
        <section class="case-study-inner-ptb"
            style="background-image: url(assets/img/case-study/case-study-03.webp); background-size: cover; background-position: top center; background-repeat: no-repeat, no-repeat;">
            <div class="container">
                <div class="row">
