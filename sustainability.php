    ...
    <main>
        ...
        <section class="our-approach"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="sec-title wow fadeInUp" data-wow-delay="0.2s">Our Approach</h2>
                        <h4 class="wow fadeInUp" data-wow-delay="0.4s">The KEY lies in finding the Right Fit</h4>
                    </div>
                </div>
                <div class="row py-4">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="right-fit">
                            <p>Right Application</p>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex justify-content-center wow fadeInUp" data-wow-delay="0.6s">
                        <div class="right-fit">
                            <p>Right Material</p>
                        </div>
                    </div>
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="right-fit float-end">
                            <p>Right Market</p>
                        </div>
                    </div>
                </div>
                <div class="process-container position-relative">
        ...
        <section class="sustainable-packaging">
            <div class="container">
                <div class="row wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="col-md-8">
                        <div class="sp-info">
                            <h6>of Consumers Prefer Sustainable Packaging -</h6>
                            <h2>Are You Ready?</h2>
