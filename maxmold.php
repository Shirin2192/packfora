...
<head>
  ...
  <meta name="keywords" content="mold management, mold tracking system, packaging molds, Maxmold software, mold lifecycle">
  <meta name="description" content="Discover Maxmold, Packfora’s proprietary system for efficient mold development, tooling reuse, and mold tracking for packaging production.">
  <meta name="author" content="Packfora">
  <link rel="canonical" href="https://packfora.com/maxmold.php">

  <!-- Title  -->
  <title>Maxmold by Packfora: Smart Mold Management</title>
  <!-- Favicon -->
  ...
  <main>
    ...
    <section class="boxes-section">
      <div class="container">
        ...
        <div class="row">
            <?php
                $query = "SELECT * FROM tbl_built_reliability WHERE is_delete = '1' ORDER BY id ASC";
          ...
          <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
            <div class="box">
              <div class="boxPara inline-arrows">
               <h5><?= nl2br($row['title']); ?></h5>
                <p class="mt-10"><?= $row['description']; ?></p>
              </div>
              <div class="text-start knowWrapp">
                <a href="javascript:void(0);" class="know-more">
                  Know More
    ...
    <?php 
// Fetch story data
$query = "SELECT * FROM tbl_story_behind_maxmold WHERE is_delete = '1' LIMIT 1";
$result = mysqli_query($conn, $query);
  ...
  <div class="container story-section">
    <div class="launchWrapp">
      ...
      <div class="story-placeholder">
        <div class="row align-items-center">
          <div class="col-md-5">
            <img src="<?= BASE_URL .htmlspecialchars($story['image']); ?>" class="wow zoomIn" alt="MaxMold Founders" data-wow-delay="0.2s">
          </div>
          <div class="col-md-7">
            <div class="maxmold-story wow zoomIn" data-wow-delay="0.2s">
              <?php 
              // Split paragraphs using double spaces or period+space logic
      ...
      <div class="launch-section">
        <h2 class="launch-title wow fadeInUp" data-wow-delay="0.2s">
          <img src="assets/img/home/mx/maxmold-color-logo.webp" alt="MaxMold Logo">
        </h2>
        <h3 class="launch-subtitle wow fadeInUp" data-wow-delay="0.3s">is Launching Soon</h3>
        <p class="launch-description wow fadeInUp" data-wow-delay="0.4s">
          Be the first to try the demo, get exclusive updates, and discover early adopter benefits.
        </p>
        <a href="contact-us.php">
          <button class="notify-btn wow fadeIn" data-wow-delay="0.3s">
            Notify Me
                ...
                <form id="maxmold_form" method="post" action="javascript:void(0)" novalidate="true">
                  ...
                  <div class="controls row">
                    <div class="col-lg-6">
                      <div class="form-group mb-4">
                        ...
                        <input id="form_name" type="text" name="name"
                          placeholder="Your full name" required="required" oninput="validateInput(this)">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                                    ...
                                    <span id="phone-error" class="error-text text-danger" style="display: none;"></span>
                                 </div>
