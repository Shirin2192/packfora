...
<head>
    ...
    <link rel="stylesheet" href="assets/css/maxhero.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a class="logo" href="index.php">
                <img src="assets/imgs/maxmold-logo.png" alt="logo">
            </a>
            <!-- navbar links -->
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item brdright">
        ...
        <div class="container-fluid rest d-flex">
            <div class="menu-links">
                <ul class="main-menu rest">
                    ...
                    <li>
                        <div class="o-hidden">
                            <a href="#" class="link">
                                <span class="fill-text" data-text="Service">Service</span>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div class="o-hidden">
                            <a href="#" class="link">
                                <span class="fill-text" data-text="Career">Career</span>
                            </a>
                        </div>
                    </li>
                    <li>
            ...
            <div class="cont-info valign">
                <div class="text-center full-width">
                    <div class="logo">
                        <img src="assets/imgs/packfora-white-logo.png" alt="">
                    </div>
                    <div class="social-icon mt-40">
                        <a href="https://www.facebook.com/people/Packfora-Solutions/61554270972448/" target="_blank"><i
                                class="fab fa-facebook-f"></i></a>
                        <a href="https://in.linkedin.com/company/packfora-llp" target="_blank"><i
                                class="fab fa-linkedin-in"></i></a>
                    </div>
                    <div class="item mt-30">
                        <h5><a href="tel:+919664973055">+91 96649 73055</a></h5>
                        <h5><a href="mailto:ankheeta.lath@packfora.com">ankheeta.lath@packfora.com</a></h5>
                        <h5><a href="mailto:contact@packfora.com">contact@packfora.com</a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main>
      ...
      <div class="circleMax">
        <div class="circlehero left-1"></div>
        <div class="circlehero left-2"></div>
        <div class="circlehero right-1"></div>
        <div class="circlehero right-2"></div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-2"></div>
          <div class="col-lg-8 text-left">
            <h2 class="hero-subheading wow fadeIn" data-wow-delay="0.2s">Molds are the heart of your
              production</h2>
            <h1 class="hero-heading wow fadeIn" data-wow-delay="0.3s">Yet their performance<br> remains a
              Black Box.</h1>
          </div>
          <div class="col-lg-2"></div>
          <div class="mt-40 d-flex justify-content-center">
            <div class="tabs-pill">
              <a class="active" href="#">Request Early Access</a>
              <a href="#">Join the Pilot Program</a>
              <a href="#">
                Try the Demo —<br>
                <small>Experience MaxMold in Action</small>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="hero-section">
            <div class="container-fluid p-md-0">
                <div class="row align-items-center">
                    <div class="col-md-2 p-0 col-1">
                        <img src="assets/img/shape/maxmold-element.png" alt="">
                    </div>
                    <div class="col-md-8 col-10">
                        <div class="m-auto" style="display: table;">
                            <h2 class="hero-subheading wow fadeIn" data-wow-delay="0.2s">Molds are the heart of your
                                production</h2>
                            <h1 class="hero-heading wow fadeIn" data-wow-delay="0.3s">Yet their performance<br> remains
                                a
                                Black Box</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="mt-50 pt-20 d-flex justify-content-center">
                            <div class="tabs-pill">
                                <a class="active" href="contact-us.php">Request Early Access</a>
                                <a href="contact-us.php">Join the Pilot Program</a>
                                <a href="contact-us.php">
                                    Try the Demo —<br>
                                    <small>Experience MaxMold in Action</small>
                                </a>
                                <!-- <a href="#">
                          Secure a Trial Spot<br>
                          Before We Go Live
                      </a> -->
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <h2 data-aos="fade-up" class="title-font">
                            <span class="counter">30</span><span>%</span>
                        </h2>
                        <p data-aos="fade-up">of mold life lost</p>
                    </div>
                    <div class="col-lg-4 mb-4 mb-lg-0 stats-border">
                        <h2 class="counter" data-aos="fade-up">Millions</h2>
                        <p data-aos="fade-up">in avoidable CapEx <br> every year</p>
                    </div>
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <h2 class="counter" data-aos="fade-up">0</h2>
                        <p data-aos="fade-up">industry-wide standards for<br>mold performance tracking</p>
                    </div>
                </div>
            </div>
        </div>
        <section class="maxmold-section">
            <div class="container-fluid px-0">
                <div class="row g-0">
                    <!-- Image Column -->
                    <div class="col-lg-6 p-0">
                        <img src="./assets/img/home/mx/maxmold-Box.png" alt="MaxMold Image" class="maxmold-image">
                    </div>
                    <!-- Text Column -->
                    <div class="col-lg-6 p-0">
                        <div class="gradient-bg">
                            <div>
                                <h2 class="wow fadeInUp" data-wow-delay="0.2s">End-to-End<br>
                                    Intelligence.<br>
                                    Strategic<br>
                                    Insights.<br>
                                    Maximum Value.</h2>
                                <p class="mt-30 wow fadeInUp" data-wow-delay="0.2s">MaxMold is a smart, secure mold
                                    lifecycle<br> platform that brings together workflow
                                    <br>intelligence, real-time monitoring, and<br> expert-built automation.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="">
            <div class="container-fluid px-0">
                <div class="row g-0">
                    <!-- Left Section -->
                    <div class="col-lg-6 p-5 purple-bg">
                        <h2 class="mb-4 mt-30 wow fadeIn" data-wow-delay="0.5s">
                            Backed by <br>
                            Packfora’s 200+ <br>
                            years of <br> collective <br>
                            expertise and <br> built
                            with leading <br> partners
                        </h2>
                        <div class="mt-4 purpleBgbtmLink">
                            <ul>
                                <li>Axiom</li>
                                <li class="stats-borderli">MaintWiz</li>
                                <li>Octet</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 bg-white p-5">
                        <div class="perWrapp pd-rl">
                            <div class="row border-bottom pb-3 wow zoomIn" data-wow-delay="0.2s">
                                <div class="col-lg-6 stat-number">
                                    15%
                                </div>
                                <div class="col-lg-6 text-left stat-text">
                                    increase in <br> mold life
                                </div>
                            </div>
                            <div class="row border-bottom py-3 wow zoomIn" data-wow-delay="0.4s">
                                <div class="col-lg-6 stat-number">
                                    10%+
                                </div>
                                <div class="col-lg-6 text-left stat-text">
                            ...
                            <div class="row border-bottom py-3 wow zoomIn" data-wow-delay="0.6s">
                                <div class="col-lg-6 stat-number">
                                    0.5-1%
                                </div>
                                <div class="col-lg-6 text-left stat-text">
                                    increase in on- <br> shelf availability
                                </div>
                            </div>

                            <div class="row py-3 pb-0 wow zoomIn" data-wow-delay="0.8s">
                                <div class="col-lg-6 stat-number">
                                    3-5X
                                </div>
                                <div class="col-lg-6 text-left stat-text">
        ...
        <section class="boxes-section">
            <div class="container">
                <h2 class="section-title text-center wow fadeInUp" data-wow-delay="0.2s">
                    Built for Reliability. Backed by Results.
                </h2>
                <div class="row">
                    <!-- Box 1 -->
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX Availability</h5>
                                <p class="mt-20">
                                    Fewer mold breakdowns = higher on-shelf availability and
                                    production continuity.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                    ...
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX <br> Quality</h5>
                                <p class="mt-20">
                                    Better mold performance delivers consistently high-quality
                                    output with fewer rejections.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                                <a href="#" class="know-more">
                    ...
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX <br> Life</h5>
                                <p class="mt-10">
                                    Extend mold lifespan by 15%+ through proactive, data-led
                                    maintenance.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                    ...
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX <br> Governance</h5>
                                <p class="mt-10">
                                    Structured governance ensures transparency, traceability, and
                                    accountability.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                    ...
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX <br> Value</h5>
                                <p class="mt-10">
                                    10%+ OPEX savings and 3-5X ROI through optimized maintenance
                                    and mold reuse.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                    ...
                    <div class="col-lg-4 col-md-6 mb-15 wow zoomIn" data-wow-delay="0.2s">
                        <div class="box">
                            <div class="boxPara inline-arrows">
                                <h5>MAX <br> Circularity</h5>
                                <p class="mt-10">
                                    Enable sustainable practices like part reuse, modular design,
                                    and smarter end-of-life decisions.
                                </p>
                            </div>
                            <div class="text-start knowWrapp">
                                <a href="#" class="know-more">
        ...
        <section class="">
            <div class="container story-section">
                <div class="launchWrapp">
                    <h3 class="wow fadeInUp" data-wow-delay="0.2s">The Story Behind MaxMold</h3>
                    <h6 class="wow fadeInUp" data-wow-delay="0.3s">Built by the people who've lived the problem.</h6>
                    <div class="story-placeholder">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <img src="assets/img/home/mx/founders.webp" class="wow zoomIn" alt="" srcset=""
                                    data-wow-delay="0.2s">
                            </div>
                            <div class="col-md-7">
                                <div class="maxmold-story wow zoomIn" data-wow-delay="0.2s">
                                    <p>MaxMold was born out of lived frustration—and a deep belief that things could be
                                        better.</p>
                                    <p><strong>Our two founders, Dahyalal Pandya and Ramaiah Muthusubramanian,</strong>
                                        spent years on the
                                        ground, managing the chaos that comes with mold failure: urgent fixes, missed
                                        timelines, and
                                        the helplessness of not knowing what went wrong until it was too late.</p>
                                    <p>They didn’t just want a better solution—they needed one.</p>
                                    <p>Inspired by structured systems in industries like aerospace and automotive, they
                                        began
                                        applying scientific principles to mold management—and saw the impact
                                        immediately. But it
                                        still relied on manual effort and personal discipline.</p>
                                    <p>That’s when the bigger vision took shape: <strong>what if we could turn this
                                            know-how into a
                                            platform? One that brings structure, foresight, and intelligence into a
                                            space that’s long
                                            been reactive and invisible.</strong>
                                    </p>
                                    <p>That vision became MaxMold.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="launch-section">
                        <h2 class="launch-title wow fadeInUp" data-wow-delay="0.2s">
                            <img src="assets/img/home/mx/maxmold-color-logo.webp" alt="" srcset="">
                        </h2>
                        <h3 class="launch-subtitle wow fadeInUp" data-wow-delay="0.3s">is Launching Soon</h3>
                        <p class="launch-description wow fadeInUp" data-wow-delay="0.4s">Be the first to try the demo,
                            get exclusive updates, and discover early
                            adopter benefits.</p>
                        <a href="contact-us.php"><button class="notify-btn wow fadeIn" data-wow-delay="0.3s">
                                Notify Me
                                <span class="arrow-line ms-2"></span>
                            </button></a>
                    </div>
                </div>
            </div>
        ...
        <!-- ==== Start Contact ==== -->
        <section class="contact-sa pt-0 contact-us-mx">
            <div class="container">
                <div class="">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="info">
                                ...
                                <div class="sec-head me-5 wow fadeInUp" data-wow-delay="0.4s">
                                    <h4>Reach out to discover how Packfora can address your unique challenges
                                        and drive
                                        sustainable success.</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="contact-form wow zoomIn" data-wow-delay="0.2s">
                                <form id="maxmold_form" method="post" action="javascript:void(0)" novalidate="true">
        ...
        <!-- ==== Start Footer ==== -->
        <footer class="footer-sa py-5 wow fadeInUp slow" data-wow-delay="0.2s"
            style="background-image: url(assets/img/footer-bg.png); background-size: contain; background-position: right center; background-repeat: no-repeat, no-repeat;">
            <div class="container">
                <div class="contact-info">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="index.php" class="logo pb-0">
                                <img src="assets/img/packfora-logo.svg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script src="assets/common/js/lib/jquery-migrate-3.4.0.min.js"></script>
    <!-- plugins -->
    <script src="assets/common/js/lib/plugins.js"></script>
    <!-- GSAP -->
    <script src="assets/common/js/gsap_lib/gsap.min.js"></script>
    <script src="assets/common/js/gsap_lib/ScrollSmoother.min.js"></script>
    <script src="assets/common/js/gsap_lib/ScrollTrigger.min.js"></script>
    <script src="assets/common/js/gsap_lib/SplitText.min.js"></script>
    <!-- common scripts -->
    ...
    <script src="assets/view_js/maxmold.js"></script>
    <script>
    AOS.init();
    </script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const tabs = document.querySelectorAll(".tabs-pill a");
