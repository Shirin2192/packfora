...
<html lang="zxx">
   <head>
      ...
      <meta name="keywords" content="packaging leadership, packfora leadership team, packaging industry leaders, packaging strategy experts">
      <meta name="description" content="Explore the experience and vision of Packfora’s leadership team driving growth and transformation in the packaging industry.">
      <meta name="author" content="Packfora">
      <link rel="canonical" href="https://packfora.com/leadership.php">
      <!-- Title  -->
      <title>Meet the Leaders Behind Packfora’s Innovation</title>
      <!-- Favicon -->
   ...
   <body>
      ...
      <main>
         ...
         <section class="page-title-banner"
            style="background-image: url(assets/img/leaders/leadership.webp); background-size: cover; background-position: top center; background-repeat: no-repeat, no-repeat;">
            <div class="overlay"></div>
            <div class="container">
               <div class="row">
                  <div class="page-title-bar text-center text-wrapper">
                     <h2 class="main-heading">Leadership Team</h2>
                     <p class="subtext">With over 1,000+ years of combined experience, Packfora's leadership team has
                        been helping businesses transform their packaging strategies. Their industry expertise fuels
                        innovation, drives global growth, and ensures lasting impact for our clients.
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="connect-expert mt-4">
                     <a href="contact-us.php" class="read_more">Reach Out to Our Experts</a>
                  </div>
               </div>
            </div>
         </section>
      ...
      <script>
         const images = document.querySelectorAll('.leader-img, .leader-name, .open-info img');
         ...
         function openPopup(data) {
             const socialLinks = JSON.parse(data.social || '{}');
         
             let socialHTML = '<div class="social-icons">';
             for (let platform in socialLinks) {
                 socialHTML += `<a href="${socialLinks[platform]}" target="_blank">
                     <img src="assets/img/leaders/linkedin.png" alt="${platform}">
                 </a>`;
             }
             socialHTML += '</div>';
             ...
             popupContent.innerHTML = `
                 <div class="popup-mob">
                     ...
                     <div id="BackBtn" class="back-button">
                         <img src="assets/img/home/intro/Vector.png" alt=""> Go Back
                     </div>
                 </div>
             `;
         ...
         // Add click event to each interactive element
         images.forEach(image => {
             image.addEventListener('click', (e) => {
                 e.preventDefault(); // Prevent anchor default behavior
                 e.stopPropagation();
         
                 const parent = image.closest('.leader');
                 const mainImage = parent.querySelector('.leader-img');
         
                 const data = {
                     title: mainImage.getAttribute('data-title'),
                     para1: mainImage.getAttribute('data-para1'),
                     para2: mainImage.getAttribute('data-para2'),
                     para3: mainImage.getAttribute('data-para3'),
                     para4: mainImage.getAttribute('data-para4'),
                     designation: mainImage.getAttribute('data-designation'),
                     social: mainImage.getAttribute('data-social')
                 };
         ...
         // Close popup when clicking on cross icon
