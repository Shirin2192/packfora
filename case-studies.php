...
<body>
    ...
    <main>
        ...
        <section class="case-study-inner-ptb"
            style="background-image: url(assets/img/case-study/case-study-banner.webp); background-size: cover; background-position: top center; background-repeat: no-repeat, no-repeat;">
            <div class="container">
                <div class="row">
        ...
        <section class="case-studies">
            <div class="container mt-5">
                <h2 class="offering-title mb-3 wow fadeIn"
                    style="color: rgb(33, 64, 154); visibility: visible; animation-name: fadeIn;">Packaging that Drives
                    Business Impact</h2>
                <p class="wow fadeInUp" data-wow-delay="0.6s"
                    style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">Real stories of how
                    Packfora helped leading brands unlock efficiency, sustainability, and value across the packaging
                    value.</p>
                <!-- Dropdown filters -->
                <div class="dropdown-container">
                    <div class="filter-dropdown dropdown" id="featured-topics">
                        <div class="dropdown-toggle d-flex justify-content-between align-items-center drop"
                ...
                <div class="content-sections">
                    <div class="row">
                        ...
                        <div class="col-lg-4 my-3 content-section"
                            data-tags="Sustainability,Sustainability & Carbon Reduction,Food & Beverage,FMCG & CPG,Procurement & Cost Reduction">
                            <div class="wow fadeInUp" data-wow-delay="0.2s"
                                style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                <div class="case-study-box">
                                    <div class="case-study-img">
                                        <img src="assets/img/case-study/case-study-thumb-01.webp"
                                            alt="Corporate team meeting around a table">
                                        <p class="badge">Foods</p>
                                        <div class="case-study-body">
                                            <a href="case-study-inner.php">
                                                <p class="meta">MAY 5, 2025</p>
                                                <h5 class="title">Packfora enabled a leading FMCG brand to cut costs by
                                                    30% while enhancing recyclability and sustainability.</h5>
                        ...
                        <div class="col-lg-4 my-3 content-section"
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="case-study-box">
                                    <div class="case-study-img">
                                        <img src="assets/img/case-study/case-study-thumb-02.webp"
                                            alt="Corporate team meeting around a table">
                                        <p class="badge">Personal Care</p>
                                        <div class="case-study-body">
                        ...
                        <!-- Case Study 3: Plastic Packaging -->
                        <div class="col-lg-4 my-3 content-section"
                            data-tags="Design-to-Value,Pack Format Innovation,Packaging Design & Engineering,Packaging Producers">
                            <div class="wow fadeInUp" data-wow-delay="0.2s"
                                style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                <div class="case-study-box">
                                    <div class="case-study-img">
                                        <img src="assets/img/case-study/case-study-thumb-03.webp"
                                            alt="Corporate team meeting around a table">
                                        <p class="badge">Plastic Packaging</p>
                                        <div class="case-study-body">
                                            <a href="1.5-litre-bottle-case-study.php">
                                                <p class="meta">MAY 1, 2025</p>
                                                <h5 class="title">Check out how Packfora reimagined packaging for a new
                                                    1.5L water bottle.</h5>
                                                <h6>Read Full Case Study</h6>
                                            </a>
                                        </div>
                                    </div>
