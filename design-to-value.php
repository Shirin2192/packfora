        ...
        <div class="offerings-container">
            <div class="all-offerings mb-4">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="offerings-card mb-4 mb-md-0 wow fadeInUp" data-wow-delay="0.2s">
...
<div class="content-area">
                                        <div class="row">
                                            <div class="col-md-4 border-end">
                                                ...
                                                <div class="strategy-item mb-4">Waste</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item">Complexity Reduction</div>
                                            </div>
                                            <div class="col-md-4 border-end">
                                                <div class="strategy-title mt-4">Replace</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item mb-4">Technology</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item">Materials</div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="strategy-title mt-4">Redesign</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item mb-4">Specification</div>
                                                <div class="divider"></div>
...
<div class="content-area">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 border-end">
                                                <div class="strategy-title">Should Cost</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item mb-4">MOQ</div>
                                                <div class="divider"></div>
                                                <div class="strategy-item">Value Chain Understanding</div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="strategy-title">Future Proofing</div>
                                                <div class="divider"></div>
                        ...
                        <div class="col-lg-4">
                            <div class="offerings-contact mb-4 mb-md-0 wow fadeInUp" data-wow-delay="0.2s"
                                style="background-image: url('assets/img/services/services-contact-us.webp'); background-repeat: no-repeat; background-position: top; background-size: cover; height: 273px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 class="wow fadeInUp" data-wow-delay="0.4s">Discover the Benefits of Design to Value</h4>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="sustainable-packaging">
            <div class="container">
                <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="col-md-9">
                        <div class="sp-info">
                            <h6 class="fz-50">Make your packaging smarter now</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
