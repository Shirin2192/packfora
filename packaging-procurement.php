 ...
 <?php include 'db_connect.php';
    ...
    <main>
        ...
        <!-- <section class="market-trends">
            <div class="container">
                <div class="row">
                    <h2 class="sec-title">Market Trends</h2>
                    <div class="col-md-3 market-trend-info market-trend-01">
                        <div class="market-info">
                            <h2>40%</h2>
                            <p>of the planet's plastic waste originates from packaging materials.</p>
                        </div>
                    </div>
                    <div class="col-md-3 market-trend-info market-trend-02">
                        <div class="market-info">
                            <h2>14.5MT.</h2>
                    ...
                    <div class="col-md-3 market-trend-info market-trend-03">
                        <div class="market-info">
                            <h2>31.3%</h2>
       ...
       <?php
        ...
        <?php
        // Run query
        $sql = "SELECT id, fk_service_id, name, designation, link, image 
                FROM tbl_our_leaders 
                WHERE is_delete = '1' AND fk_service_id =8
                ORDER BY id ASC";
        ...
        <section class="sustainable-packaging">
            <div class="container">
                <div class="row wow fadeInUp" data-wow-delay="0.2s">
                    <div class="col-md-9">
                        <div class="sp-info">
                            <h6 class="fz-50">Transform Your Packaging Now</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
