...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-title-bar text-center">
                        ...
                        <h1 class="wow fadeInUp" data-wow-delay="0.2s">Services</h1>
                        ...
                        <div class="about-banner-btn mt-40 wow fadeInUp" data-wow-delay="0.2s">
                            <a href="#get-in-touch" class="read_more">About Us</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ==== Start Services ==== -->
        <div class="services-container py-5" style="background: #efefef;">
            <div class="all-services">
                <div class="container">
                    <div class="row">
                        <h2 class="offering-title mb-3 wow fadeIn" style="color: #21409A;">Our Services</h2>
                        <p class="service-info mb-4 wow fadeInUp" data-wow-delay="0.2s" style="color: #21409A;">Our company unites multi-disciplinary expertise across the entire packaging value chain to create packaging solutions that are innovative, sustainable, and tailored to our clients' needs.</p>
                    </div>
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.2s">
                                <div class="service-img">
                                    <img src="assets/img/services/talent-flexx.webp" class="w-100">
                                </div>
                                <div class="service-content services-content">
                                    <h4 class="mb-2">Talent Flex</h4>
                                    <p>Elevate your capabilities with specialized industry experts that deliver
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.4s">
                                <div class="service-img">
                                    <img src="assets/img/services/sustainability.webp" class="w-100">
                                </div>
                                <div class="service-content services-content">
                                    <h4 class="mb-2">Sustainability</h4>
                                    <p>Reduce waste, boost recyclability, and ensure compliance while maximizing
                                        the profitability of your packaging operations.</p>
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.6s">
                                <div class="service-img">
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 wow fadeInUp slow" data-wow-delay="0.8s">
                                <div class="service-img">
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 mb-md-0 wow fadeInUp slow" data-wow-delay="0.8s">
                                <div class="service-img">
                                    <img src="assets/img/services/packaging-procurement.webp" class="w-100">
                                </div>
                                <div class="service-content services-content">
                                    <h4 class="mb-2">Packaging Procurement</h4>
                                    <p>Source smarter with high-performance, ESG-aligned procurement that
                                        enhances efficiency and market impact.</p>
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 mb-md-0 wow fadeInUp slow" data-wow-delay="0.2s">
                                <div class="service-img">
                        ...
                        <div class="col-lg-3">
                            <div class="services-big-card mt-2 mb-4 mb-md-0 wow fadeInUp slow" data-wow-delay="0.4s">
                                <div class="service-img">
                        ...
                        <div class="col-lg-6">
                            <div class="service-contact mt-2 mb-4 mb-md-0 wow fadeInUp slow" data-wow-delay="0.6s"
