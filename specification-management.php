            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 class="wow fadeInUp" data-wow-delay="0.4s">Discover the Benefits of Supply Chain Automation
                        </h4>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="leaders wow zoomIn" data-wow-delay="0.4s">
                            <img src="assets/img/teams/bhaskarn.webp" class="w-100">
                            <p>Baskaran Thiagarajan<br>Home & Personal Care<br><a href="https://www.linkedin.com/in/baskaran-thiagarajan/?originalSubdomain=in" target="_blank">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="leaders wow zoomIn" data-wow-delay="0.4s">
                            <img src="assets/img/teams/rodney.webp" class="w-100">
                            <p>Rodney Pease<br>Foods, Pharma & CHC (USA)<br><a href="https://www.linkedin.com/in/rodney-pease-2768a850/" target="_blank">
                                    <img src="assets/img/leaders/linkedin.png" alt="" class="p-2">
                                </a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="leaders wow zoomIn" data-wow-delay="0.4s">
                            <img src="assets/img/teams/sai.webp" class="w-100">
                            <p>Sai Goutham Nuvvula<br>SHPCO<br><a href="https://www.linkedin.com/in/sai-goutham-n-0aa51176/" target="_blank">
                                    <img src="assets/img/leaders/linkedin.png" alt="" class="p-2">
                                </a></p>
                        </div>
                    </div>
        ...
        <section class="sustainable-packaging">
            <div class="container">
                <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="col-md-9">
                        <div class="sp-info">
                            <!-- <h2 class="fz-50">Transform Your Supply Chain Automation Today</h2> -->
                            <h6 class="fz-35">Let’s Build Clarity into Your Specs <br>
                                From migration to everyday change management - we’re here to help.</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
